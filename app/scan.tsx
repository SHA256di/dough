...
export default function ScanScreen() {
  ...
  const processAndNavigate = async (uri: string) => {
    ...
    setLoading(true);
    const text = await sendImageToClaude(manipulated.base64, 'image/jpeg');
    try {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Scan closing stock</Text>
      <Text style={styles.subtitle}>
        Take a photo or pick one from your library. Claude will identify baked goods and estimate quantities.
      </Text>
